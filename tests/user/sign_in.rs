...
async fn sign_in_with_invalid_url() {
  let url_str = "appflowy-flutter://#access_token=DUMMY_ACCESS_TOKEN&expires_in=3600&provider_token=DUMMY_PROVIDER_TOKEN&refresh_token=DUMMY_REFRESH_TOKEN&token_type=bearer";
  let c = localhost_client();
